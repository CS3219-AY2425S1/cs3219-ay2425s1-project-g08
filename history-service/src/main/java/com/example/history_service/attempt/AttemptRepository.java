...
/**
 * Repository interface for performing CRUD operations on Attempt documents in MongoDb.
 *
...
public interface AttemptRepository extends MongoRepository<Attempt, String> {
     ...
     *
     * @param userId the unique identifier of the user whose attempts are to be retrieved.
